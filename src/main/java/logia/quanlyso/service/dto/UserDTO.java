...
public class UserDTO {
	 ...
	 * @param authorities
	 *            the authorities
	 * @param grantAccessDate
	 *            the grant access date
	 * @param revokeAccessDate
	 *            the revoke access date
	 */
	...
	public String toString() {
		return "UserDTO{" + "login='" + this.login + '\'' + ", firstName='" + this.firstName + '\'' + ", lastName='"
				...
				+ ", activated=" + this.activated + ", langKey='" + this.langKey + '\'' + ", createdBy="
				+ this.createdBy + ", createdDate=" + this.createdDate + ", lastModifiedBy='" + this.lastModifiedBy
				+ '\'' + ", lastModifiedDate=" + this.lastModifiedDate + ", authorities=" + this.authorities
				+ ", grantAccessDate=" + this.grantAccessDate + ", revokeAccessDate=" + this.revokeAccessDate + "}";
	}
}
