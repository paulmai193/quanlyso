...
public class TransactionsDTO implements Serializable {
	 ...
	 *
	 * @param transactionDetailsDTOs
	 *            the transactionDetailsDTOs to set
	 */
	...
	public String toString() {
		return "TransactionsDTO{" + "id=" + id + ", chosenNumber='" + chosenNumber + '\'' + ", netValue=" + netValue
				+ ", cost=" + cost + ", openDate=" + openDate + ", clientsId=" + clientsId + ", transactionDetailsDTOs="
