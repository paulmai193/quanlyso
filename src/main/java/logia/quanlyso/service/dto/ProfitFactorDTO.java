...
public class ProfitFactorDTO implements Serializable {
	...
	public boolean equals(Object o) {
		...
		if (profitFactorDTO.getId() == null || this.getId() == null) {
			return false;
		}
		return Objects.equals(this.getId(), profitFactorDTO.getId());
	}
	...
	public String toString() {
		return "ProfitFactorDTO{" + "id=" + this.getId() + ", rate='" + this.getRate() + "'" + "}";
	}
}
