...
public class Transactions extends AbstractAuditingEntity implements Serializable {
	...
	public String toString() {
		return "Transactions{" + "id=" + id + ", chosenNumber='" + chosenNumber + '\'' + ", netValue=" + netValue
				+ ", openDate=" + openDate + ", transactionDetails=" + transactionDetails + ", users=" + users
				+ ", cost=" + cost + '}';
	}
}
