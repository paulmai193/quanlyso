...
public class TransactionDetails implements Serializable {
	...
	public String toString() {
		return "TransactionDetails{" + "id=" + id + ", amount=" + amount + ", profit=" + profit + ", costs=" + costs
				+ ", transactions=" + transactions + ", channels=" + channels + ", styles=" + styles + ", types="
				+ types + ", costRate=" + costRate + '}';
	}
}
