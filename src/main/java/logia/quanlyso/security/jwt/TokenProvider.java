...
public class TokenProvider {
	...
	public void init() {
		...
		this.tokenValidityInMilliseconds = 1000 * this.jHipsterProperties.getSecurity()
				.getAuthentication().getJwt().getTokenValidityInSeconds();
		this.tokenValidityInMillisecondsForRememberMe = 1000 * this.jHipsterProperties.getSecurity()
	...
	public String createToken(Authentication authentication, Boolean rememberMe) {
		...
		return Jwts.builder().setSubject(authentication.getName())
				.claim(TokenProvider.AUTHORITIES_KEY, authorities).signWith(SignatureAlgorithm.HS512, this.secretKey)
